...
export class ProgramsService {
  private programs: any[] = [
    {
      ...
      overview:
        'The Bachelor of Science in Geology program provides students with a comprehensive understanding of Earth sciences, including mineralogy, petrology, structural geology, and environmental geology. Students gain hands-on experience through fieldwork and laboratory studies.',
      objectives: [
    ...
    },
    {
      ...
      description:
        'Pure and applied mathematics program with strong analytical focus',
      icon: 'fas fa-calculator',
      level: 'bachelor',
      duration: '4 years (8 semesters)',
      overview:
        'The Mathematics program offers a rigorous education in pure and applied mathematics, developing strong analytical and problem-solving skills. Students explore various mathematical fields and their applications in science, technology, and industry.',
      objectives: [
    ...
    },
    {
      ...
      description:
        'Comprehensive physics program covering theoretical and experimental aspects',
      icon: 'fas fa-atom',
      level: 'bachelor',
      duration: '4 years (8 semesters)',
      overview:
        'The Physics program provides a thorough understanding of physical laws and principles, combining theoretical knowledge with experimental skills. Students explore classical and modern physics, preparing them for careers in research, technology, and education.',
      objectives: [
    ...
    },
    {
      ...
      duration: '4 years (8 semesters)',
      overview:
        'The Chemistry program offers extensive training in all areas of chemistry, emphasizing both theoretical understanding and practical laboratory skills. Students gain experience in modern analytical techniques and chemical research methods.',
      objectives: [
    ...
    },
    {
      ...
      duration: '4 years (8 semesters)',
      overview:
        'This interdisciplinary program combines botany and microbiology, providing students with comprehensive knowledge of plant biology, microbial systems, and their interactions. Students gain practical experience in modern biotechnology techniques.',
      objectives: [
    ...
    },
    {
      ...
      description:
        'Advanced graduate program in environmental research and management',
      icon: 'fas fa-globe-americas',
      level: 'master',
      duration: '2 years (4 semesters)',
      overview:
        "The Master's program in Environmental Sciences provides advanced training in environmental research, assessment, and management. Students conduct original research and develop expertise in environmental problem-solving.",
      objectives: [
  ...
  getByLevel(level: string): any[] {
    return this.programs.filter((p: any) => p.level === level);
  }

  getByDepartment(department: string): any[] {
    return this.programs.filter((p: any) => p.department === department);
  }

  getActivePrograms(): any[] {
    return this.programs.filter((p: any) => p.isActive);
  }
  ...
  getTotalCredits(): number {
    return this.programs.reduce((sum, p: any) => sum + p.creditsRequired, 0);
  }
}
