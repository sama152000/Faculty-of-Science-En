...
export class SectorsService {
  private sectors: any[] = [
    {
      ...
      description:
        'Managing academic programs, curriculum, and educational quality',
      icon: 'fas fa-graduation-cap',
      overview:
        'The Academic Affairs Sector is responsible for overseeing all academic activities within the Faculty of Science, including curriculum development, academic standards, student assessment, and educational quality assurance.',
      responsibilities: [
    ...
    },
    {
      ...
      overview:
        'The Research and Graduate Studies Sector focuses on advancing scientific research, supporting graduate programs, and fostering innovation within the faculty. We coordinate research activities and provide support for postgraduate studies.',
      responsibilities: [
    ...
    },
    {
      ...
      description:
        'Supporting student life, welfare, and extracurricular activities',
      icon: 'fas fa-users',
      overview:
        'The Student Affairs and Services Sector is dedicated to enhancing student experience through comprehensive support services, extracurricular activities, and welfare programs that contribute to holistic student development.',
      responsibilities: [
    ...
    },
    {
      ...
      overview:
        "The Administrative and Financial Affairs Sector ensures efficient management of the faculty's administrative operations, financial resources, human resources, and infrastructure to support academic and research activities.",
      responsibilities: [
    ...
    },
    {
      ...
      description:
        'Connecting with community and promoting environmental sustainability',
      icon: 'fas fa-leaf',
      overview:
        'The Community Service and Environmental Development Sector focuses on building strong community partnerships, promoting environmental awareness, and contributing to sustainable development initiatives in the region.',
      responsibilities: [
  ...
  searchSectors(query: string): any[] {
    const q = query.toLowerCase();
    return this.sectors.filter(
      (s) =>
        s.name.toLowerCase().includes(q) ||
        s.description.toLowerCase().includes(q) ||
        s.responsibilities.some((r: string) => r.toLowerCase().includes(q))
    );
  }
  ...
  getSectorsByStaffCount(): any[] {
    return this.sectors.sort(
      (a, b) => (b.staffCount || 0) - (a.staffCount || 0)
    );
  }
}
